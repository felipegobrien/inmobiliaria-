...
class _DetailScreenState extends State<DetailScreen> {
          ...
          builder: (ctx, setSheet) => Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Déjale tus datos a la inmobiliaria para ver el contacto.',
  ...
  Future<void> _openWhatsApp(String number, String title) async {
    ...
    final msg = Uri.encodeComponent('Hola, estoy interesado en el inmueble "$title".');
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: 'Compartir',
            onPressed: () {
              // Enlace al sitio propio de la inmobiliaria (marca blanca),
              // nunca al portal general.
              final url =
                  '${AgencyManager.current!.siteBase}/inmueble/${propertySlug(p)}';
