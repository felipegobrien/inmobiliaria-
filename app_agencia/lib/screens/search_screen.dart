...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _load() {
    ...
    PropertyService.search(_agency.id, _filters).then((data) {
      if (!mounted) return;
      setState(() {
        _results = data;
        _loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // Encabezado con la marca de la inmobiliaria
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: (_agency.avatarUrl != null &&
                            _agency.avatarUrl!.isNotEmpty)
                        ? CachedNetworkImage(
                            imageUrl: _agency.avatarUrl!,
                            fit: BoxFit.cover,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            _loading
                                ? 'Cargando…'
                                : '${_results.length} inmuebles disponibles',
                            style: const TextStyle(
